<?php
	...
	*/
	...
	for($j=31; $j <=90; $j++){
	$manufacture = array();
	$xml = simplexml_load_file('http://www.biludstyr.dk/dynamic.aspx?data=APIIMAGES&key=22846020:66822&output=xml&RowspPage=1000&PageNumber='.$j.'&dataonly=true');
	$i = 0;
	
	$writer = new \Zend\Log\Writer\Stream(BP . '/var/log/apiproducdaddimage_page33.log');
